 ...
 * @author Sahani
 */
public class guardianDetails extends javax.swing.JFrame {

    /**
     * Creates new form guardianDetails
     */
...
//go to the doctor interface which gives to add details
    private void btNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNextActionPerformed
        ...
        //pd.guardian_id=txtNIC.getText();

        System.out.println(txtNIC.getText());

//connect to database to add details        
        try {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new guardianDetails().setVisible(true);
            }
        });
    }
