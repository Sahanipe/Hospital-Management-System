 ...
 * @author Sahani
 */
public class ViewPatientD extends javax.swing.JFrame {

    /**
     * Creates new form ViewPatientD
     */
    public ViewPatientD() {
        initComponents();
    }
...
//connect to database and show the given details
...
//connect to database and delete the records
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPatientD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPatientD().setVisible(true);
            }
        });
    }
